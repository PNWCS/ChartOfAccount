...
using Serilog;
using QB_Terms_Lib;  // <-- Replace with your actual library namespace
using QBFC16Lib;              // QuickBooks session and API interaction
using static QB_Terms_Test.CommonMethods;  // <-- Adjust if you store test helpers in a different namespace
using QB_Terms_Test;
